...
void BulletHandler::CreateBullet(sf::Vector2f pos, int speed, int angle) {
	bullets.push_back(std::make_unique<Bullet>(pos, speed, angle, bulletTexture, sf::Vector2u{ 1920,1080 }));
}
